/**
 * Round-trip properties (Phase 0.3): diagnostic notation of generated CBOR
 * parses back to the same bytes; compose agrees with parse; the prefix
 * parser consumes exactly the item.
 */
