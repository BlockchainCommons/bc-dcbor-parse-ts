...
`@blockchaincommons/dcbor-parse` depends on `@blockchaincommons/dcbor-compat`, `@blockchaincommons/known-values`, `@blockchaincommons/tags`, `@blockchaincommons/uniform-resources` at runtime.
