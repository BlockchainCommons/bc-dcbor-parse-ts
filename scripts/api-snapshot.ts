 ...
 * Public-API snapshot.
 *
 * Snapshots the built public type declarations of both entry points
 * (dist/index.d.mts, dist/lexer.d.mts) to api/<entry>.d.mts, so any change
 * to the public surface is a reviewable diff.
 *
